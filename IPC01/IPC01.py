...
def checkParkingSpace(imgPro):
    ...
    for pos in posList:
        ...
        d = spaceCounter
        with open('Parking_Zone_A.txt', 'w') as f:
            f.write(str(d) + '\n')
    ...
    # Show Info on Camera
    cvzone.putTextRect(img, f'Parking Zone A : {spaceCounter} from {len(posList)} Slot', (20, 49), scale=3,
                       thickness=3, offset=20, colorR=(0, 0, 0))

    # Show Info Full Screen
    # cvzone.putTextRect(img, f'Parking Zone A : {spaceCounter}', (430, 150), scale=7,
...
while True:
    ...
    cv2.imshow("Tni Parking IPC01", img)
