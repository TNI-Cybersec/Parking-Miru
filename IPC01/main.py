...
def checkParkingSpace(imPro):
    ...
    for pos in posList:
        ...
        # Show Info on Camera
        cvzone.putTextRect(im, f'Parking Lot Left : {spaceCounter} from {len(posList)}', (20, 49), scale=3,
                           thickness=3, offset=20, colorR=(0, 0, 0))

    # Show Info Full Screen
    # cvzone.putTextRect(im, f'Parking Lot Left : {spaceCounter}', (430, 150), scale=7,
